...
const ArchitectureSection = ({ id }) => {
    return (
        <>
            <section className="bg-slate-50 scroll-mt-24"
            ...
            >
                ...
                >
                    ...
                    <div className="grid  md:grid-cols-3 gap-6 mt-14 md:mt-16 lg:gap-8" >
                        <div className="bg-white  w-full  shadow-sm rounded-xl border border-slate-200 p-8 transition-all hover:-translate-y-1 duration-300 hover:shadow-md">
                        ...
                        {/* card 3 */}
                        <div className="bg-white  w-full  shadow-sm rounded-xl border border-slate-200 p-8 transition-all hover:-translate-y-1 duration-300 hover:shadow-xl">
