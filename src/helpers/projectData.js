...
const apv = {
    ...
    images: [`${rutaAPV}1-register.png`, `${rutaAPV}2-activateAccount.png`, `${rutaAPV}3-login.png`, `${rutaAPV}4-form.png`, `${rutaAPV}5-created.png`,`${rutaAPV}6-edit.png`, `${rutaAPV}7-recoveryPassword.png`,`${rutaAPV}8-newPassword.png`],
