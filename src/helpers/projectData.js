...
const freshCoffee = {
    ...
    repo:[{frontend:'https://github.com/Luismy-182/React-FreshCoffe', backend:'https://github.com/Luismy-182/Laravel-FreshCoffe.git'}]
}
...
const apv = {
    ...
    repo:[{git:'https://github.com/Luismy-182/APV-MERN---Full-Stack'}]
}
const devJobs = {
    id: 'devJobs',
    ...
    repo:[{git:'https://github.com/Luismy-182/devjobs.git'}]
}
